    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"""
                ...
                {json_str}
                Please Modify the JSON file to make the sprite loop through the followin$g movement 10 times: say I love UVA!, move forward 15 steps, wait 1 second, then turn 15 degrees, all when the green flag is clicked.
...
def compress_files_to_zip(zip_filename, files):
    ...
    print("Files compressed into output.zip")
