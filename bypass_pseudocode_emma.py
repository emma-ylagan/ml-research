...
def main():
    ...
    compress_files_to_zip("output_emma.zip", files_to_compress) #compress files into output.zip
    zip_to_sb3("output_emma.zip", "scratch_emma.sb3") #convert output.zip into scratch.sb3
